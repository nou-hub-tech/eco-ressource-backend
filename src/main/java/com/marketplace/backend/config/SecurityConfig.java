  ...
  public SecurityFilterChain securityFilterChain(
    ...
    http
      ...
      .authorizeHttpRequests(auth -> auth
        ...
        // =========================================================
        // 🔥 DEV MODE (ALLOW YOUR FRONTEND TO WORK)
        // =========================================================

        .requestMatchers("/api/reservation-slots/**").authenticated()
        .requestMatchers("/api/reservations/with-slot/**").authenticated()
        .requestMatchers("/api/reservation-slots/recommend").permitAll()
        ...
        .requestMatchers("/api/transporters/**").hasRole("ADMIN")

        // 🔒 authenticated APIs
        .requestMatchers("/api/listings/**").authenticated()
        .requestMatchers("/api/products/**").authenticated()
        .requestMatchers("/api/stock-items/**").authenticated()
        .requestMatchers("/api/stock-movements/**").authenticated()
        .requestMatchers("/api/resource-listings/**").authenticated()
